...
export class ComponentService {
  ...
  add(pageComponent: PageComponent) {
    ...
    return this.http.post<any>(environment.apiUrl + action, pageComponent).pipe(
      map((data) => {
        return data;
      })
    );
  ...
  update(pageComponent: PageComponent) {
    var action = "components";
    return this.http.put<any>(environment.apiUrl + action, pageComponent).pipe(
      map((data) => {
        return data;
      })
    );
  ...
  publishComponent(id): Observable<PageComponent[]> {
    return this.http.get<any>(`${environment.apiUrl}components/publish?id`).pipe(
      map((data) => {
