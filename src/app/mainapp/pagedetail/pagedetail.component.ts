...
export class PagedetailComponent {
  ...
  saveData() {
    if (this.data) {
      ...
      this.pageService.add(this.data).subscribe((result) => {
        ...
        if (result.id) {
          ...
          this.snakbar.open('Your page has been updated successfully.', 'Ok', {
            duration: 2000,
          });
         ...
         // alert("Sorry, we are unable to update your page");
          ...
          this.snakbar.open('Sorry, we are unable to update your page', 'Ok', {
            duration: 2000,
          });
      ...
      this.pageService.add(page).subscribe((result) => {
        ...
        if (result.id) {
          ...
          this.snakbar.open('Your page has been created successfully.', 'Ok', {
            duration: 2000,
          });
