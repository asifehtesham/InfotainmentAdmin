...
@Component({
  ...
  templateUrl: './sqd-designer.component.html',
  styleUrls: ['./sqd-designer.component.scss']
})
export class SqdDesignerComponent implements AfterViewInit, OnChanges, OnDestroy {
