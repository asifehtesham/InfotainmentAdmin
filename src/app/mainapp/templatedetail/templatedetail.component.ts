...
@Component({
  ...
  styleUrls: ["./templatedetail.component.scss"],
})
export class TemplatedetailComponent {
  ...
  saveData() {
    if (this.data) {
      ...
      this.templatesService.add(this.data).subscribe((result) => {
      ...
      this.templatesService.add(temp).subscribe((result) => {
        ...
        if (result.id) {
          ...
          this.snakbar.open('Congractulations! Your page has been created successfully.', 'Ok', {
            ...
            return this.router.navigate([`/mainapp/design/template/${result.id}`]);
        } else {
